...
#import "YYAnimatedImageView+Flat.h"
//: #import <objc/runtime.h>
#import <objc/runtime.h>

//: @implementation YYAnimatedImageView (iOS14)
@implementation YYAnimatedImageView (Flat)
...
+ (void)load {
    ...
    _dispatch_once(&onceToken, ^{
        ...
        method1 = class_getInstanceMethod([self class], @selector(intervalerlayerred:));
...
- (void)intervalerlayerred:(CALayer *)layer {
