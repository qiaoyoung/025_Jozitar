...
- (NSDictionary *)item
{
    ...
    if (dict == nil) //解析过一次后就缓存解析结果，避免多次解析
    {
        ...
        objc_setAssociatedObject(self,&kOperationUtility,dict,OBJC_ASSOCIATION_COPY);
    }
    //: return dict;
    return dict;
...
@implementation NSDictionary (Grad)
