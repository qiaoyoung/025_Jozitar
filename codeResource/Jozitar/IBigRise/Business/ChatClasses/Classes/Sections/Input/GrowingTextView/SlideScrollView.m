...
- (void)spaces:(NSNotification *)notification
{
...
- (instancetype)initWithFrame:(CGRect)frame textContainer:(NSTextContainer *)textContainer
{
    ...
    if (self) {
        ...
        [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(spaces:) name:UITextViewTextDidChangeNotification object:self];
    }
    //: return self;
    return self;
}
