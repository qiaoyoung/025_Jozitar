...
@interface SprechstimmeRepresent : NSObject
...
@property (nonatomic,readonly) NSTimeInterval graceVersion;
...
@property (nonatomic) BOOL requireConvertComments;
...
//: @property (nonatomic, readonly) UIEdgeInsets contentViewInsets;
@property (nonatomic, readonly) UIEdgeInsets perInsets;
...
//: @property (nonatomic, readonly) CGPoint avatarMargin;
@property (nonatomic, readonly) CGPoint withValue;
...
@property (nonatomic) BOOL zoneProgress;
