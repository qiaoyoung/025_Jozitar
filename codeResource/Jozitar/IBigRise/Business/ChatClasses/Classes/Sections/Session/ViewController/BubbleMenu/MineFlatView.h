...
- (void)elide:(NSArray *)array
                 ...
                 channel:(CGRect)cursorStartRect addedByBlock:(CGRect)rect presentUponBlock:(void(^)(DramItem *item))block;
//: + (instancetype)shareMenuView;
+ (instancetype)sevenfold;// 单例模式
