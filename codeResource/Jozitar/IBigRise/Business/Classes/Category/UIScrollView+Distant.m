...
- (void)placementRemote{
    ...
    switch (self.position) {
        ...
        case EnumPullToRefreshPositionTop:
            ...
            if((fabs(self.scrollView.contentOffset.headGiven) < 1.19209290e-7F)) {
        ...
        case EnumPullToRefreshPositionBottom:
            ...
            if(((fabs(self.scrollView.contentOffset.headGiven) < 1.19209290e-7F) && self.scrollView.contentSize.height < self.scrollView.bounds.size.height)
               ...
               || (fabs((self.scrollView.contentOffset.headGiven) - (self.scrollView.contentSize.height - self.scrollView.bounds.size.height)) < 1.19209290e-7F)) {
                ...
                [self.scrollView setContentOffset:(CGPoint){.headGiven = ((self.scrollView.contentSize.height - self.scrollView.bounds.size.height) > (0.0f) ? (self.scrollView.contentSize.height - self.scrollView.bounds.size.height) : (0.0f)) + self.frame.size.height} animated:YES];
                //: self.wasTriggeredByUser = NO;
                self.wasTriggeredByUser = NO;
...
- (void)layoutSubviews {
    ...
    if(hasCustomView) {
        ...
        [customView setFrame:CGRectMake(origin.x, origin.headGiven, viewBounds.size.width, viewBounds.size.height)];
    }
    //: else {
    else {
        //: switch (self.state) {
    ...
    if(self.state != EnumPullToRefreshStateLoading) {
        ...
        switch (self.position) {
            ...
            case EnumPullToRefreshPositionTop:
                ...
                scrollOffsetThreshold = self.frame.origin.headGiven - self.originalTopInset;
                //: break;
                break;
            //: case EnumPullToRefreshPositionBottom:
            case EnumPullToRefreshPositionBottom:
        ...
        else if(contentOffset.headGiven < scrollOffsetThreshold && self.scrollView.isDragging && self.state == EnumPullToRefreshStateStopped && self.position == EnumPullToRefreshPositionTop)
        ...
        else if(contentOffset.headGiven >= scrollOffsetThreshold && self.state != EnumPullToRefreshStateStopped && self.position == EnumPullToRefreshPositionTop)
            //: self.state = EnumPullToRefreshStateStopped;
            self.state = EnumPullToRefreshStateStopped;
        ...
        else if(contentOffset.headGiven > scrollOffsetThreshold && self.scrollView.isDragging && self.state == EnumPullToRefreshStateStopped && self.position == EnumPullToRefreshPositionBottom)
            //: self.state = EnumPullToRefreshStateTriggered;
            self.state = EnumPullToRefreshStateTriggered;
        ...
        else if(contentOffset.headGiven <= scrollOffsetThreshold && self.state != EnumPullToRefreshStateStopped && self.position == EnumPullToRefreshPositionBottom)
            //: self.state = EnumPullToRefreshStateStopped;
            self.state = EnumPullToRefreshStateStopped;
    //: } else {
    } else {
        ...
        switch (self.position) {
            ...
            case EnumPullToRefreshPositionTop:
                ...
                offset = ((self.scrollView.contentOffset.headGiven * -1) > (0.0f) ? (self.scrollView.contentOffset.headGiven * -1) : (0.0f));
...
- (void)loading {
    ...
    CGFloat offset = ((self.scrollView.contentOffset.headGiven * -1) > (0) ? (self.scrollView.contentOffset.headGiven * -1) : (0));
    //: UIEdgeInsets currentInsets = self.scrollView.contentInset;
    UIEdgeInsets currentInsets = self.scrollView.contentInset;
    //: switch (self.position) {
    switch (self.position) {
