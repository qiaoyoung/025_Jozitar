...
extern __attribute__((visibility ("default"))) NSString *const widgetRetainWindowPage(NSString *value);/** Touken前缀*/

extern __attribute__((visibility ("default"))) NSString *const themePoneTimer(NSString *value);/** 加密密钥*/

extern __attribute__((visibility ("default"))) NSString *const featureColorLargeEffectKey(NSString *value);/** 即时聊天*/
