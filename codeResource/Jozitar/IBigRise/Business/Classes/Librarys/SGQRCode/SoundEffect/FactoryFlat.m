...
@implementation FactoryFlat

//: - (void)play {
- (void)reach {
    //: AudioServicesPlaySystemSound(_soundID);
    AudioServicesPlaySystemSound(_join);
}
...
+ (id)sound:(NSString *)path {
    ...
    if (path) {
        ...
        return [[FactoryFlat alloc] initWithNewscast:path];
    }
    //: return nil;
    return nil;
}
...
- (void)dealloc {
    ...
    AudioServicesDisposeSystemSoundID(_join);
}
