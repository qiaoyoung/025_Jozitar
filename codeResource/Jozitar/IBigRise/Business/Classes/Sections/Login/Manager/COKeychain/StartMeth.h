...
//: @property (nonatomic) SAMKeychainQuerySynchronizationMode synchronizationMode;
@property (nonatomic) SAMKeychainQuerySynchronizationMode quickMode;
...
- (BOOL)tableGenerate:(NSError **)error;
...
- (BOOL)informationFetch:(NSError **)error;
...
- (nullable NSArray<NSDictionary<NSString *, id> *> *)agree:(NSError **)error;
