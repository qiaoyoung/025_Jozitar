...
@interface GradAgreeView : UITableViewCell

//: @property (strong, nonatomic) UIButton *acceptButton;
@property (strong, nonatomic) UIButton *acceptButton;
//: @property (nonatomic,strong) UILabel *titleLabel;
@property (nonatomic,strong) UILabel *relativeMethodValid;
...
@property (weak, nonatomic) id<CarefulFill> actionDelegate;
...
- (void)motion:(NIMSystemNotification *)notification;
//: @end
@end