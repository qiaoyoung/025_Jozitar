 ...
 *
 * 如果您在使用 Helper 的过程中出现bug或有更好的建议,还请及时以下列方式联系我,我会及
 * 时修复bug,解决问题.
 *
...
+ (__kindof NSURLSessionTask *)disturbing:(NSString *)URL
...
+ (__kindof NSURLSessionTask *)colorSort:(NSString *)URL
                         //: parameters:(id)parameters
...
+ (__kindof NSURLSessionTask *)up:(NSString *)URL
                                      //: parameters:(id)parameters
...
+ (void)setPutDown:(void(^)(AniDetailed *sessionManager))sessionManager;
...
+ (__kindof NSURLSessionTask *)special:(NSString *)URL
                                        //: parameters:(id)parameters
...
+ (__kindof NSURLSessionTask *)agreement:(NSString *)URL
                                       //: fileDir:(NSString *)fileDir
                                       cleanFailure:(NSString *)fileDir
                                      //: progress:(YLHttpProgress)progress
                                      take:(YLHttpProgress)progress
                                       //: success:(void(^)(NSString *filePath))success
                                       duringLetter:(void(^)(NSString *filePath))success
                                       //: failure:(YLHttpRequestFailed)failure;
...
+ (__kindof NSURLSessionTask *)firstName:(NSString *)URL
                                       //: parameters:(id)parameters
                                       theOperation:(id)parameters
                                             //: name:(NSString *)name
                                             prepare_strong:(NSString *)name
                                             //: data:(NSData *)data
                                             streetwise_strong:(NSData *)data
                                         //: fileName:(NSString *)fileName
                                         with:(NSString *)fileName
                                        //: imageType:(NSString *)imageType
                                        image:(NSString *)imageType
                                         //: progress:(YLHttpProgress)progress
                                         alongsideDown:(YLHttpProgress)progress
                                          //: success:(YLHttpRequestSuccess)success
                                          suggest:(YLHttpRequestSuccess)success
                                          //: failure:(YLHttpRequestFailed)failure;
                                          baggage:(YLHttpRequestFailed)failure;
 ...
 */
//: + (__kindof NSURLSessionTask *)POST:(NSString *)URL
+ (__kindof NSURLSessionTask *)enterSure:(NSString *)URL
                         //: parameters:(id)parameters
                         bound:(id)parameters
                      //: responseCache:(YLHttpRequestCache)responseCache
