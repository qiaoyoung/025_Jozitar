...
- (NSString *)calculateAppResPath {
    ...
    NSString *resDir = [docuPath stringByAppendingPathComponent:kUnderOwnerQuality];
    ...
    NSString *fileResDir = [[docuPath stringByAppendingPathComponent:@"file"] stringByAppendingPathComponent:kUnderOwnerQuality];
    ...
    NSString *path = [[AppleProjectKit sharedKit].emoticonBundle pathForResource:kUnderOwnerQuality ofType:@".zip"];
    if (!path) {
